...
const page = () => {
    return (
        ...
        <section class="hero_box">
            <Image src="../public/assets/imgs/logo-no-background.png" alt="Prep & Learn Logo" class="hero_logo" />
            <h2 class="tagline fancy_tagline">
                Inspiring Potential, Encouraging Dreams
            </h2>
            <h2 class="tagline">Your Portal to Free Learning</h2>
            <p class="intro">
            ...
            <button class="action_btns">Get Started</button>
        </section>
        <section class="LR_box imgR">
            <div class="left_side">
                <h3 class="sub_heading fancy_tagline">
            ...
            <div class="right_side">
                <Image src="../public/assets/imgs/590.jpg" alt="A vector graphic of a book with a light bulb near it."
                    class="graphic_art" />
                <a href="https://www.vecteezy.com/free-vector/studying">Studying Vectors by Vecteezy</a>
            </div>
        </section>
        <section class="LR_box imgL">
            <div class="left_side">
                <Image src="../public/assets/imgs/AI.jpg"
        ...
        <section class="LR_box imgR">
            <div class="left_side">
                <h3 class="sub_heading fancy_tagline">Navigating the Limitations</h3>
                <p class="content">
            ...
            <div class="right_side">
                <Image src="../public/assets/imgs/636_generated.jpg"
                    alt="A vector graphic of a people trying to piece together a light bulb" class="graphic_art" />
                <a href="https://www.vecteezy.com/free-vector/web">Web Vectors by Vecteezy</a>
            </div>
        </section>
        <section class="hero_box final_box">
            <div class="final_box_in_view"></div>
            <h2 class="tagline">
            ...
            <button onclick="toggleView()" class="last_call_btn btn-5">
                Take the first step
            </button>
        </section>
    </main>
